...
<html>
    <head>
        ...
        <!--<script src="../js/js_tablas.js"></script>-->
        <script>
    ...
    <body>
        ...
        $l = 0;
        if (!$_GET['pag']) {
            header('Location: listadoLibros.php?pag=1');
        } else {
            $contenidoPorPag = 3;
            $w = $_SESSION['totalUsu'];
            $pagTotal = count($w);
            ...
            <div class="row">
                <div class="col-md col-sm col-lg">
                    <div class="breadcrumb">
                        ...
                        <div class="breadcrumb-item active">Listar Libros</div>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <form class="form-inline" action="../../controlador/controladorLibro.php" method="POST">
                                    <tr>
                                        <td><img id="fotoLibro" class="img-fluid" src="data:image/jpeg;base64,<?php echo base64_encode($key->getFoto()); ?>" alt='Foto no encontrada'/></td>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            if (isset($_SESSION['u'])) {
                                                                ...
                                                                <form class="form-inline" action="../../controlador/controladorGeneral.php" method="POST">
                                                                    ...
                                                                    <div class="form-group mt-3 mb-3">
                                                                        <input type="text" style="border:none" name="usuario" value="<?php echo $u->getNombre(); ?>"/> 
                                                                    </div>
                                                                    <div class="form-group mt-3 mb-3">
                                                                        <label>Asunto: </label>
        ...
        <nav aria-label="pagination">
            <ul class="pagination">
                <li class="page-item <?php echo $_GET['pag'] <= 1 ? 'disable' : '' ?>">
                    <a class="page-link" href="listadoLibros.php?pag=<?php $_GET['pag'] - 1; ?>">Previus</a>
                </li>
                <?php
                for ($i = 0; $i < $paginas; $i++) {
                    ?>
                    <li class="page-item <?php echo $_GET['pag'] == $i + 1 ? 'active' : '' ?>">
                        <a class="page-link" id="pagina" href="listadoLibros.php?pag=<?php echo $i + 1; ?>"><?php echo $i + 1; ?></a>
                    </li>
                    <?php
                }
                ?>
                <li class="page-item <?php echo $_GET['pag'] >= $paginas ? 'disable' : '' ?>">
                    <a class="page-link" href="listadoLibros.php?pag=<?php echo$_GET['pag'] + 1; ?>">Next</a>
                </li>
            </ul>
        </nav> 
        <?php
